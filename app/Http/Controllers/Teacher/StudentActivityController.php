...
class StudentActivityController extends Controller
{
    ...
    {
        $data['classs'] = Educlass::where('category_id',auth('teacher')->user()->category_id)->get();
        $data['students'] = Studentadmission::where('status',1)->where('category_id',auth('teacher')->user()->category_id)->get();
       
        return view('backend.dashboard.teacher.activity.index-activity', $data);
    ...
    public function activityCreate($id){
        ...
        return view('backend.dashboard.teacher.activity.create',compact('data'));
    }
    public function activityStore(Request $request){
        ...
        return redirect()->route('teacher.activity.index')->with($notification);
