...
class StudentActivityController extends Controller
{
    public function index()
    {
        ...
        return view('backend.dashboard.teacher.activity.activity-list', $data);
    }

    public function create()
    {
        $data['classs'] = Educlass::where('id', auth('teacher')->user()->class_id)->first();
        $data['students'] = Studentadmission::where('status', 1)->where('class_id', auth('teacher')->user()->class_id)->get();
        $data['activityLIst'] = ActivityList::where('status', 1)->get();
        return view('backend.dashboard.teacher.activity.create-activity', $data);
    }
    ...
    public function activity_show($class, $date)
    {
        ...
        //return $data;
        return view('backend.dashboard.teacher.activity.list-student', $data);
    }
    public function show($id)
    {
        ...
        // return $data;
        return view('backend.dashboard.teacher.activity.show-activity', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['activity'] = StudentActivity::find($id);
        return view('backend.dashboard.teacher.activity.edit-activity', $data);
    }
    ...
    {
        $data['students'] = Studentadmission::Orderby('roll', 'asc')->where('status', 1)->where('class_id', Auth('teacher')->user()->class_id)->get();

        return view('backend.dashboard.teacher.activity.average-activity', $data);
    }
    ...
    public function reportIndex()
    {
       ...
       return view('backend.dashboard.teacher.student-report.report-index',compact('data'));
    }
    public function reportComplete()
    {
       ...
       return view('backend.dashboard.teacher.student-report.complete-report',compact('data'));
    }
    public function reportShow($id)
    {
        $data = DailyReport::find($id);
       return view('backend.dashboard.teacher.student-report.show',compact('data')); 
    }
