...
$.fn.hijriDate = function (options = {}) {
  ...
  const hijriMonths = {
    ar: ["Muharram", "Safar", "Rabi Al-Awwal", "Rabi Al-Akhar", "Jumada Al-Awwal", "Jumada Al-Akhirah", "Rajab", "Shaban", "Ramadan", "Shawwal", "Dhu Al-Qidah", "Dhul Al-Hijjah"],
  ...
  const hijriSymbol = (defaultOptions.hijriLang === 'ar') ? 'H' : '';
