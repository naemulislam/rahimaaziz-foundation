                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('admin.group.destroy', $row->id) }}"
                                    ...
                                    <div class="modal fade" id="row_status_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.group.status', $row->id) }}" method="post">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="editmodal_{{ $row->id }}" data-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.group.update', $row->id) }}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <div class="form-group">
