...
@section('title','accountant Edit Password')
@section('content')
        ...
        <div class="container">
            ...
            <div class="d-flex flex-row">
                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{Auth('accountant')->user()->name}}</a>
                            ...
                            <div class="py-9">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="#" class="text-muted text-hover-primary">{{Auth('accountant')->user()->email}}</a>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-2">Phone:</span>
                                    <span class="text-muted">{{Auth('accountant')->user()->phone}}</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
                                    <span class="font-weight-bold mr-2">Location:</span>
                                    <span class="text-muted">{{Auth('accountant')->user()->c_address}}</span>
                                </div>
                            </div>
                            <!--end::Contact-->
                            <!--begin::Nav-->
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="{{route('accountant.profile')}}" class="navi-link py-4 ">
                ...
                <div class="flex-row-fluid ml-lg-8">
                    <!--begin::Card-->
                    <form class="form" action="{{ route('accountant.upassword')}}" method="post">
                        @csrf
                        <div class="card card-custom card-stretch">
                            <!--begin::Header-->
