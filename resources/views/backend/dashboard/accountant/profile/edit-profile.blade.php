...
<section>
    <div class="card card-custom gutter-b example example-compact">
        ...
        <!--begin::Form-->
        <form action="{{route('accountant.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline" id="kt_image_4" style="background-image: url(assets/media/users/blank.png)">
                                            <div class="image-input-wrapper" style="background-image: url(@if(!empty(Auth('accountant')->user()->profile_photo_path)) {{asset( Auth('accountant')->user()->profile_photo_path ) }} @else {{asset('defaults/avatar/avatar.png')}} @endif)"></div>
