                            ...
                            <form action="{{ route('admin.achievement.update', $achievement->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="date" value="{{ $achievement->date}}">
                                            @error('date')
                                            <span class="text-danger">{{ $message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Enter description about achievement.." name="description">{{ $achievement->description }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <img class="previewImage" id="output" src="{{asset($achievement->document)}}" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
