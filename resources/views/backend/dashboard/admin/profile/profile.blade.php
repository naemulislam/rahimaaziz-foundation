            ...
            <div class="col-md-3">
                <div class="left-sec">
                    <div class="profile-pic text-center">
                        <img width="100px" class="mb-4" src="@if(!empty(Auth('admin')->user()->profile_photo_path)) {{ asset(Auth('admin')->user()->profile_photo_path)}}
                    ...
                    <div class="profile-dtls">
                        ...
                        <div class="dtls-box">
                            <p>Designation</p>
                            <p>{{ Auth('admin')->user()->designation }}</p>
                        </div>
                        <div class="dtls-box">
                            <p>Department</p>
                            <p>{{ Auth('admin')->user()->department }}</p>
                        </div>

                        <div class="dtls-box">
                            <p>Basic Salary</p>
                            <p>{{ Auth('admin')->user()->basic_salary }}</p>
                        </div>
                        <div class="dtls-box">
                            <p>Contract Type</p>
                            <p>Permanent</p>
                        ...
                        <div class="dtls-box">
                            <p>Work Shift</p>
                            <p>{{ Auth('admin')->user()->work_shift }}</p>
                        </div>
                        
                        <div class="dtls-box">
                            <p>Data of Joining</p>
                            <p>{{ Auth('admin')->user()->date_of_joining }}</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->phone }}</dd>
                                                    <b class="col-sm-3">Emergency Contact Number</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->ec_number }}</dd>
                                                    <b class="col-sm-3">Email</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->email }}</dd>
                                                    ...
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->date_of_birth }}</dd>
                                                    <b class="col-sm-3">Marital Status</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->marital_status }}</dd>
                                                    <b class="col-sm-3">Father Name</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->father_name }}</dd>
                                                    <b class="col-sm-3">Mother Name</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->mother_name }}</dd>
                                                    <b class="col-sm-3">Qualification</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->qualification }}</dd>
                                                    <b class="col-sm-3">Work Exprince</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->work_exprince }}</dd>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->c_address }}</dd>
                                                    <b class="col-sm-3">Permanent Address</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('admin')->user()->p_address }}</dd>
                                        ...
                                        <div class="btn-edit float-right mt-3">
                                            <a href="{{ route('admin.edit',auth('admin')->user()->id) }}" class="btn btn-primary">Edit Profile</a>
                                        </div>
