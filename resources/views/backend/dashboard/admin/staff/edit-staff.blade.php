                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{route('admin.staff.index') }}" class="btn btn-primary btn-sm font-weight-bolder">
                                    < Back</a>
                                        <!--end::Button-->
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.staff.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Staff name" value="{{$data->name}}" name="name">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="">Staff Email<span class="text-danger">*</span></label>
                                            <input type="email" class="form-control" name="email" id="email" placeholder="Enter unique email" value="{{$data->email}}">
                                            <div style='color:red; padding: 0 5px;'>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="">Staff Department<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Staff Image</label>
