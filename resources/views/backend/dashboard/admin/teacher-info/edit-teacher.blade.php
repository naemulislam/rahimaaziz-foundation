                            ...
                            <form action="{{ route('admin.teacher.update',$teacher->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter teacher name" name="name" value="{{$teacher->name}}">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" placeholder="Enter unique email" value="{{$teacher->email}}">
                                            <div style='color:red; padding: 0 5px;'>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="phone" value="{{$teacher->phone}}" placeholder="Enter phone">
                                            <div style='color:red; padding: 0 5px;'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control" id="">
                                                ...
                                                <option value="1" @if($teacher->gender == 1) selected @endif>Mail</option>
                                                <option value="2" @if($teacher->gender == 2) selected @endif>Femail</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{asset('backend')}}/assets/media/users/blank.png)">
                                        <div class="image-input-wrapper" style="background-image: url({{asset($teacher->profile_photo_path)}})"></div>
