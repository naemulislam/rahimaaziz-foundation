                ...
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            @else
                                Online Student Admission Details
                            @endif
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="@if ($student->admission_status == 1) {{ route('admin.admission.index') }} @else {{ route('admin.admission.pending') }} @endif"
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-3 mx-auto">
                            <div class="imageBox">
                                <img src="@if (!empty($student->image)) {{ asset($student->image) }} @else {{ asset('defaults/noimage/no_img.jpg') }} @endif"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <b class="col-sm-9">{{ $student->admission->admission_no ?? 'N/A' }}</b>
                        <b class="col-sm-3">Roll No</b>
                        <b class="col-sm-9">{{ $student->admission->roll ?? 'N/A' }}</b>
                        ...
                        <b class="col-sm-9">
                            {{ $student->studentinfo->father_langu_spoken ?? 'N/A' }}</b>
                        <b class="col-sm-3">Mother Name</b>
                        <b class="col-sm-9">
                            {{ $student->studentinfo->mother_name }}
                        </b>
                        <b class="col-sm-3">Mother Call</b>
                        <b class="col-sm-9">{{ $student->studentinfo->mother_call }}</b>
                        <b class="col-sm-3">Mother Email</b>
                        <b class="col-sm-9">{{ $student->studentinfo->mother_email ?? 'N/A' }}</b>
                        <b class="col-sm-3">Mother Language Spoken</b>
                        <b class="col-sm-9">{{ $student->studentinfo->mother_langu_spoken ?? 'N/A' }}</b>
                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            @if ($student->admission->b_certificate)
                                                <embed src="{{ asset($student->admission->b_certificate) }}"
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body">
                                            @if ($student->admission->immu_record)
                                                <embed src="{{ asset($student->admission->immu_record) }}" width="100%"
                                                    height="400px" />
                                            @else
                                                Not abed yet.
                                            @endif
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                        ...
                                        <div class="card-body">
                                            @if ($student->admission->proof_abress)
                                                <embed src="{{ asset($student->admission->proof_abress) }}"
                                                    width="100%" height="400px" />
                                            @else
                                                Not abed yet.
                                            @endif
                                    ...
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                        ...
                                        <div class="card-body">
                                            @if ($student->admission->mrrcfps)
                                                <embed src="{{ asset($student->admission->mrrcfps) }}" width="100%"
                                                    height="400px" />
                                            @else
                                                Not abed yet.
                                            @endif
                                    ...
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                        ...
                                        <div class="card-body">
                                            @if ($student->admission->physical_health)
                                                <embed src="{{ asset($student->admission->physical_health) }}"
                                                    width="100%" height="400px" />
                                            @else
                                                Not abed yet.
                                            @endif
                    ...
                    @if ($student->admission_status == 0)
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('admin.admission.edit', $student->slug) }}" type="submit"
                                    class="btn btn-primary">Admission Approved</a>
                            </div>
                        </div>
                    @endif
