            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Galleries List
                                ...
                                <tr>
                                    ...
                                    @if (Auth('admin')->user())
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('admin.gallery.destroy', $gallery->id) }}"
                                ...
                                <div class="modal fade" data-backdrop="static" id="row_status_{{ $gallery->id }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.gallery.status', $gallery->id) }}" method="post">
                                                @csrf
