                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    @else
                                    <form action="{{route('hr.class.destroy',$row->id)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="modal fade" id="row_status_{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('hr.class.status',$row->id)}}" method="post">
                                            @csrf
                            ...
                            <div class="modal fade" id="editmodal_{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('hr.class.update',$row->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="class_name" value="{{$row->class_name}}" placeholder="Enter Class name" class="form-control">
                                                    <div style='color:red; padding: 0 5px;'>{{($errors->has('class_name'))?($errors->first('class_name')):''}}</div>
                                                </div>
                                                <div class="form-group">
...
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('hr.class.store')}}" method="post">
                @csrf
                <div class="modal-body">
