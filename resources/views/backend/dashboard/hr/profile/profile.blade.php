            ...
            <div class="col-md-3">
                <div class="left-sec">
                    <div class="profile-pic text-center">
                        <img width="100px" class="mb-4" src="@if(!empty(Auth('hr')->user()->profile_photo_path)) {{ asset(Auth('hr')->user()->profile_photo_path)}}
                    ...
                    <div class="profile-dtls">
                        ...
                        <div class="dtls-box">
                            <p>Designation</p>
                            <p>{{ Auth('hr')->user()->designation }}</p>
                        </div>
                        <div class="dtls-box">
                            <p>Department</p>
                            <p>{{ Auth('hr')->user()->department }}</p>
                        </div>

                        <div class="dtls-box">
                            <p>Basic Salary</p>
                            <p>{{ Auth('hr')->user()->basic_salary }}</p>
                        </div>
                        <div class="dtls-box">
                            <p>Contract Type</p>
                            <p>Permanent</p>
                        ...
                        <div class="dtls-box">
                            <p>Work Shift</p>
                            <p>{{ Auth('hr')->user()->work_shift }}</p>
                        </div>
                        
                        <div class="dtls-box">
                            <p>Data of Joining</p>
                            <p>{{ Auth('hr')->user()->date_of_joining }}</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->name }}</dd>
                                                    <b class="col-sm-3">Phone</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->phone }}</dd>
                                                    <b class="col-sm-3">Emergency Contact Number</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->ec_number }}</dd>
                                                    <b class="col-sm-3">Email</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->email }}</dd>
                                                    <b class="col-sm-3">Gender</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">
                                                        @if(Auth('hr')->user()->gender == 1 )
                                                        Mail
                                                        @else
                                                        Femail
                                                        @endif
                                                    ...
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->date_of_birth }}</dd>
                                                    <b class="col-sm-3">Marital Status</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->marital_status }}</dd>
                                                    <b class="col-sm-3">Father Name</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->father_name }}</dd>
                                                    <b class="col-sm-3">Mother Name</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->mother_name }}</dd>
                                                    <b class="col-sm-3">Qualification</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->qualification }}</dd>
                                                    <b class="col-sm-3">Work Exprince</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->work_exprince }}</dd>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->c_address }}</dd>
                                                    <b class="col-sm-3">Permanent Address</b>
                                                    <b class="col-sm-1">:</b>
                                                    <dd class="col-sm-8">{{ Auth('hr')->user()->p_address }}</dd>
                                        ...
                                        <div class="btn-edit float-right mt-3">
                                            <a href="{{ route('hr.edit',auth('hr')->user()->id) }}" class="btn btn-primary">Edit Profile</a>
                                        </div>
