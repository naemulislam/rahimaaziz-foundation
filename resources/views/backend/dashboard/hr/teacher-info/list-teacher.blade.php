                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{route('admin.teacher.show',$row->slug)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-eye"></i></a>
                                    <a href="{{route('admin.teacher.edit',$row->slug)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-edit"></i></a>
                                    ...
                                    @else
                                    <form action="{{route('admin.teacher.destroy',$row->id)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
