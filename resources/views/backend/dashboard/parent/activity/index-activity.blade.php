                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('activity.index')}}" class="btn btn-primary btn-sm font-weight-bolder">
                                    See All Activity</a>
                        ...
                        <!--begin::Form-->
                        <div class="card-body">
                            <form action="{{ route('find.activity')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="">
                                    ...
                                    <tbody id="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('activity.show',$row->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
