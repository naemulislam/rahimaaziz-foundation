                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Edit Prayer Information</h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter salah name" name="name" value="{{ $prayer->name}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="start_time" value="{{ $prayer->start_time}}">
                                            <div style='color:red; padding: 0 5px;'>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="end_time" value="{{ $prayer->end_time}}">
                                            <div style='color:red; padding: 0 5px;'>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="order" value="{{ $prayer->order}}" placeholder="Salah Serial number">
                                            <div style='color:red; padding: 0 5px;'>
