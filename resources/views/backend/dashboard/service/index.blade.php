                                ...
                                @foreach ($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($service->document)
                                                <a target="_blank"
                                                    href="{{ asset($service->image) }}">Document</a>
                                            @else
                                                Blank
                                            @endif
                                        </td>
                                        <td>
                                            @if ($service->status == 1)
                                                <a href="#"
                                                    ...
                                                    data-toggle="modal"
                                                    @if (Auth('admin')->user()) data-target="#row_status_{{ $service->id }}" @endif>
                                                    Active</a>
                                    ...
                                    <!--Row Status -->
                                    <div class="modal fade" data-backdrop="static" id="row_status_{{ $service->id }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" class="form-control">
                                                                <option value="1"
                                                                    @if ($service->status == 1) selected @endif>Active
                                                                </option>
                                                                <option value="0"
