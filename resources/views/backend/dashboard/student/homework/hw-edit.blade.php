        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Edit Submitted Home Work</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Edit Home Work</h3>
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{route('student.hw.index') }}" class="btn btn-primary btn-sm font-weight-bolder">
                                    < Back</a>
                                        <!--end::Button-->
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <option>Select Subject</option>
                                                ...
                                                <option @if($homework->subject_id == $subject->id ) selected @endif value="{{$subject->id}}">{{ $subject->sub_name}}</option>
                                                @endforeach
