                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="py-9">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="text-muted">{{ @$stuinfo_data->h_address}}</span>
                                </div>
                            </div>
                            <!--end::Contact-->
                            <!--begin::Nav-->
                        ...
                        <form class="form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text" value="{{@$admission_data->category->category_name}}" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">Seciton</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text" value="{{@$admission_data->section->name}}" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control form-control-lg form-control-solid" type="text" value="@if(@$stuinfo_data->gender == 1) Mail @elseif(@$stuinfo_data->gender == 2) Femail @else Not added yet. @endif" readonly/>
                                    </div>
                                </div>
