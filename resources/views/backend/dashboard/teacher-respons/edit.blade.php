            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <div class="card-body">
                            <form action="{{ route('admin.respons.update', $teacherResponsibility->id) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="teacher_id" class="form-control">
                                                ...
                                                @foreach ($teachers as $row)
                                                    <option {{ $teacherResponsibility->teacher_id == $row->id? 'selected':''}}
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="respons_date" class="form-control"
                                                value="{{ $teacherResponsibility->respons_date }}">
                                                @error('respons_date')
                                                <span class="text-danger">{{ $message}}</span>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" class="" name="responsibility">
                                                {!! $teacherResponsibility->responsibility !!}
                                            </textarea>
