            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <div class="card-body">
                            <form action="{{ route('teacher.activity.store')}}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="student_id" class="form-control js-select-result" id="adstudent_id">
                                                <option value="--Select--">--Select--</option>
                                                @foreach($students as $row)
                                                <option value="{{$row->id}}">{{ $row->student->name}}</option>
                                                @endforeach
...
<script>
    $(function() {
        $(document).on('change', '#adcategory_id', function() {
            ...
            $.ajax({
                type: "Get",
                url: "{{url('/teacher/dashboard/ge/class')}}/" + category_id,
                dataType: "json",
