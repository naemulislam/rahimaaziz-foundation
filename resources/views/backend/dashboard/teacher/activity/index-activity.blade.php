                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('teacher.activity.index')}}" class="btn btn-primary btn-sm font-weight-bolder">
                                     See All Activity</a>
                        ...
                        <!--begin::Form-->
                        <div class="card-body">
                            <form  action="{{route('teacher.find.activity')}}" method="POST">
                                @csrf
                                <div class="row">
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="">
                                    ...
                                    <tbody id="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('teacher.activity.show',$row->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-eye"></i></a>
                                                @if($data)
                                                <a href="{{ route('teacher.activity.edit',$row->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-edit"></i></a>
                                                @else
                                                <a href="{{route('teacher.activity.activityCreate',$row->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3"><i class="fa fa-edit"></i></a>
                                                @endif
                                                ...
                                                <a id="delete" href="{{route('teacher.activity.delete',$row->id)}}" class="btn btn-icon btn-danger btn-hover-primary btn-xs mx-3">
