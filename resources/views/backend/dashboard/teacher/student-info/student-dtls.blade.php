            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('teacher.student.index') }}" class="btn btn-primary btn-sm font-weight-bolder">
                            < Back</a>
                                <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <b class="col-sm-1"> : </b>
                        <dd class="col-sm-8">
                            @if(@$studentinfo->h_address)
                            {{ @$studentinfo->h_address }}
                            @else
                            Not added yet
                            @endif
                        </dd>
                        <b class="col-sm-3">Apartment</b>
                        <b class="col-sm-1"> : </b>
                        <dd class="col-sm-8">
                            @if(@$studentinfo->apartment)
                            {{ @$studentinfo->apartment }}
                            @else
                            Not added yet
                            @endif
                        </dd>
