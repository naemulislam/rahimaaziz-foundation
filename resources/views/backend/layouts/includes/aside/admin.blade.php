...
<li class="menu-item {{$routeName == 'admin.dashboard'? 'menu-item-active':''}}" aria-haspopup="true">
                                ...
                                {{
                                    ...
                                    $routeName == 'admin.masjid.gallery.index' ? 'menu-item-open':''}}
                                " aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item menu-item-submenu {{ $routeName == 'admin.masjid.slider.index'? 'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
											...
											<li class="menu-item menu-item-submenu {{ $routeName == 'admin.prayer.index'? 'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                                            ...
                                            {{ $routeName == 'admin.service.index' ||
                                            $routeName == 'admin.service.create' ||
                                            $routeName == 'admin.service.edit'? 'menu-item-active':''}}
                                            " aria-haspopup="true" data-menu-toggle="hover">
											...
											<li class="menu-item menu-item-submenu {{ $routeName == 'admin.masjid.gallery.index'? 'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
