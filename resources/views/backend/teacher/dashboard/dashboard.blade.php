...
@section('content')
	...
	$countGroup = \App\Models\Group::where('status',1)->count();
	...
	$countParant = \App\Models\User::count();
	@endphp
	<!--begin::Entry-->
							...
							<div class="card-spacer mt-n25">
								...
								<div class="row m-0">
									<div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
										...
										<a href="#" class="text-warning font-weight-bold font-size-h6">Admin ( {{$countAdmin}} )</a>
									</div>
								...
								<div class="row m-0">
                                    ...
                                    <div class="col bg-light-primary px-6 py-8 rounded-xl mr-7 mb-7">
										...
										<a href="
										{{route('teacher.teacher.index')}}" class="text-primary font-weight-bold font-size-h6 mt-2">Parant ( {{$countParant}} )</a>
									</div>
                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mb-7">
										...
										<a href="{{route('teacher.group.index')}}" class="text-warning font-weight-bold font-size-h6 mt-2">Groups ( {{$countGroup}} )</a>
									</div>
								</div>
								<!--end::Row-->
							</div>
