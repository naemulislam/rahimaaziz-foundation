...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            <!--begin::Aside-->
            @include('backend.teacher.layouts.includes.aside')
            <!--end::Aside-->
            <!--begin::Wrapper-->
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    ...
                                    <span
                                        class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ auth('teacher')->user()->name }}</span>
                                    <?php
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url(@if (!empty(Auth('teacher')->user()->image)) {{ asset(Auth('teacher')->user()->image) }} @else {{ asset('defaults/avatar/avatar.png') }} @endif)">
                    </div>
                    <i class="symbol-badge bg-success"></i>
                </div>
                <div class="d-flex flex-column">
                    <a href="{{ route('teacher.profile') }}"
                        class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth('teacher')->user()->name }}</a>
                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span
                                    class="navi-text text-muted text-hover-primary">{{ Auth('teacher')->user()->email }}</span>
                            </span>
                        </a>
                        @include('backend.teacher.layouts.includes.menu.logout')
                    </div>
                </div>
            </div>
            <!--end::Header-->
