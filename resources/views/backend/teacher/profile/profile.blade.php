            ...
            <div class="container">
                ...
                <div class="d-flex flex-row">
                            ...
                            <div class="card-body pt-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                        <div class="symbol-label" style="background-image:url(@if(!empty(Auth('teacher')->user()->profile_photo_path)) {{ asset(Auth('teacher')->user()->profile_photo_path)}} @else {{ asset('defaults/avatar/avatar.png') }} 
										@endif )"></div>
                    ...
                    <div class="flex-row-fluid ml-lg-8">
                        <!--begin::Card-->
                        <form class="form" action="{{ route('teacher.update',Auth('teacher')->user()->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card card-custom card-stretch">
                                <!--begin::Header-->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <h5 class="font-weight-bold mb-6">teacher Info</h5>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{asset('backend')}}/assets/media/users/blank.png)">
                                                <div class="image-input-wrapper" style="background-image: url(@if(!empty(Auth('teacher')->user()->profile_photo_path)) {{ asset(Auth('teacher')->user()->profile_photo_path)}} @else {{ asset('defaults/avatar/avatar.png') }} 
										@endif )"></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg input-group-solid">
                                                ...
                                                <input type="text" name="c_address" class="form-control form-control-lg form-control-solid" value="{{Auth('teacher')->user()->c_address}}" placeholder="Enter Address" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg input-group-solid">
                                                ...
                                                <input type="text" name="p_address" class="form-control form-control-lg form-control-solid" value="{{Auth('teacher')->user()->p_address}}" placeholder="Enter permanent Address" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group input-group-lg input-group-solid">
                                                ...
                                                <input type="text" class="form-control form-control-lg form-control-solid" value="{{Auth('teacher')->user()->class->class_name}}" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <option @if(Auth('teacher')->user()->gender == 1) selected @endif value="1">Mail</option>
                                    <option @if(Auth('teacher')->user()->gender == 2) selected @endif value="2">Femail</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
