...
<section class="faq-section py-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
              <ul>
                <li>Mufti Mohammed Abdullah</li>
                <li>Mufti Mohammed Hafiz Ullah</li>
                <li>Mufti Mohammed Nasir Ullah</li>
                <li>Maulana Mohammed Nayeem Ullah</li>
                <li>Hafez Maulana Anwar Hussain Sheikh</li>
                <li>Hafez Maulana Raihan</li>
                <li>Brother Minhaz Mahmood</li>
                <li>Brother Mizaan </li>
                <li>Muallimah Umme Saajid</li>
                <li>Muallimah Umme Asif</li>
                <li>Muallimah Umme Zakariyya</li>
              </ul>
            </div>
            <div class="col-md-6">
...
<section>
    ...
    <div class="row mb-4">
        ...
        <div class="">
            ...
            <div class="prayer-box">
               <div class="px-4">
               <h4 class="m-0">Janaazah</h4>
               <div class="title-bb"></div>
               </div>
            </div>
            <div class="prayer-box">
               <div class="px-4">
               <h4 class="m-0">Taraweeh</h4>
               <div class="title-bb"></div>
               </div>
            </div>
            <div class="prayer-box">
               <div class="px-4">
               <h4 class="m-0">Eidain Salah</h4>
               <div class="title-bb"></div>
               </div>
            </div>
            <div class="prayer-box">
