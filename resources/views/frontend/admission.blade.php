...
@section('content')
    ...
    $seat = $setting->admission_quota ?? 0;
            ...
            <form action="{{ route('payment.store') }}" method="POST" id="payment-form" enctype="multipart/form-data">
                ...
                <div class="form">
                    ...
                    <div class="form-content">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter your place of birth" name="place_of_birth"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter your bood group" name="blood"
                                                value="{{ old('blood') }}" />
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Birth Certificate<span
                        ...
                        <button type="button" class="btnSubmit" data-toggle="modal"
                            data-target="#paymentModal">Submit</button>
                    </div>
                </div>
        </div>
    @endif
