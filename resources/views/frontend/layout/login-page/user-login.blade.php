					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin">
							...
							<form action="{{route('login')}}" method="POST" class="form" novalidate="novalidate" id="kt_login_signin_form">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Rahima Aziz Foundation Group</h3>
						...
						<div class="login-form login-signup">
							...
							<form class="form" action="{{route('site.userregister')}}" method="POST" novalidate="novalidate" id="kt_login_signup_form">
								...
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="text" placeholder="Enter your full name" name="name"/>
									<div style="color:red; padding:0 5px;">{{($errors->has('name'))?($errors->first('name')):''}}</div>
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="email" placeholder="Enter your email" name="email"/>
									<div style="color:red; padding:0 5px;">{{($errors->has('email'))?($errors->first('email')):''}}</div>
								</div>
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="number" placeholder="Enter your phone number" name="phone"/>
									<div style="color:red; padding:0 5px;">{{($errors->has('phone'))?($errors->first('phone')):''}}</div>
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="password" placeholder="Password" name="password"/>
									<div style="color:red; padding:0 5px;">{{($errors->has('password'))?($errors->first('password')):''}}</div>
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="password" placeholder="Confirm password" name="password_confirmation"/>
